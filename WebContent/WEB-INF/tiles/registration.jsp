...
<div class="col-xs-12">
	<sf:form class="form-horizontal" method="post"
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-xs-12">
					<sf:input id="fullname" path="fullname" name="fullname" type="text"
						placeholder="Enter your Full name" class="form-control input-md" />
			...
			<label for="Authontication">Authontication</label> <br>
			<!-- 
				<input
 ...
 -->
			<div class="form-check form-check-inline">
				<input type="radio" class="form-check-input" id="materialInline1"
					name="authority" value="ROLE_ADMIN" checked> <label
					class="form-check-label" for="materialInline1">ADMIN</label>
			</div>

			<!-- Material inline 2 -->
			<div class="form-check form-check-inline">
				<input type="radio" class="form-check-input" id="materialInline2"
					name="authority" value="ROLE_ACCOUNTANT"> <label
					class="form-check-label" for="materialInline2">ACCOUNTANT</label>
			</div>

			<!-- Material inline 2 -->
			<div class="form-check form-check-inline">
				<input type="radio" class="form-check-input" id="materialInline2"
					name="authority" value="ROLE_EMPLOYEE"> <label
					class="form-check-label" for="materialInline2">EMPLOYEE</label>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-12">
					<button id="submit" name="submit" class="btn btn-lg btn-success btn-block">Submit</button>
				</div>
			</div>
