...
public class UsersInfoController {
	...
	public String asd(Model model, Principal principal) {
		...
		Loan runningLoanInformations = loanService.getRunningLoanInformations(userId);
		model.addAttribute("runningLoanInformations", runningLoanInformations);
		System.out.println("Amount : "+ runningLoanInformations);
	...
	public String showCurrentUserProfileObject(@PathVariable int id, Model model, Principal principal) {
		...
		UserinfoUpdateableData userinfoUpdateableData = userinfoService
				.getCurrentUserinfoUpdateableData(principal.getName());
	...
	public String supdateCurrentUserProfileObject(@Valid UserinfoUpdateableData userinfoUpdateableData, Model model,
	...
	public String doCreate(Model model, @Valid Userinfo userinfo, BindingResult result) {// spring magically inject
		...
		if (userinfoService.exists(userinfo.getUsername())) {
			result.rejectValue("username", "DuplicateKey.userinfo.username",
