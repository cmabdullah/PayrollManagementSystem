...
public class SendMessageService {
	...
	public void postLeaveRejectionMessage(int id) throws IOException, Exception {
		...
		String message = "Hi " + leave.getFullname() + " your leave request " + leave.getEntryfrom() + " to "
				+ leave.getEntryto() + " has been rejeced";
		...
		// INFO - Showing retrive leave info for perform messaging operationLeave
		// [id=32, reasone=,m/,.ml, entryfrom=2018-11-01T00:00,
		// entryto=2018-11-16T00:00, userinfo_id=2020, status=2, leavetype=regular,
		// entryfromString=null, entrytoString=null, total_leave_days=16, fullname=MR
		// Bin, email=bin@gmail.com, deniedLeaveRequest=0]
	}
	...
	public void givePermissionToPaySalary() {// by admin
	...
	// deque automatically
	public String isMenagerPermissionGiven(String flag) {
		// just message class
		LeaveMessage leaveMessage = new LeaveMessage();
		String queueName = "isApprovedByAdmin";
		String mapkey = "pendingsalary";
		...
		if (flag.equals("y")) {
			// !dequeue
			redisMessage = messageDao.getRedisMessagefromQueueAndNotDequeue(queueName, mapkey, leaveMessage);
			return redisMessage;
		} if (flag.equals("n")) {
			// dequeue
			redisMessage = messageDao.getRedisMessagefromQueue(queueName, mapkey, leaveMessage);
			return redisMessage;
		} else {
			return redisMessage = "Sorry"; //mock return
		}
	}
	...
	// deque automatically
	public String isMenagerBonusPermissionGiven(String flag) {
		// just message class
		LeaveMessage leaveMessage = new LeaveMessage();
		String queueName = "isApprovedByAdmin";
		String mapkey = "pendingbonus";
